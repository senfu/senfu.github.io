...
2. Install Jekyll building environment, including `Ruby`, `RubyGems`, `GCC` and `Make` following [the installation guidgem **install **jekylle](https://jekyllrb.com/docs/installation/#requirements).
